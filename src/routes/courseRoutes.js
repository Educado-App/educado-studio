...
// Update Course
router.post("/course/update", restricted, async (req, res) => {
...
router.post("/course/delete", restricted, async (req, res) => {
...
router.post("/section/create", restricted, async (req, res) => {
...
// Get all sections
router.post("/course/getallsections", restricted, async (req, res) => {
...
router.post("/section/delete", restricted, async (req, res) => {
...
router.post("/component/delete", restricted, async (req, res) => {
...
// Delete all documents for user
router.get("/course/delete_all", restricted, async (req, res) => {
