...
const quizSchema = new Schema({
  question: { textQuestion: String, audioQuestion: String }, // First string is the question, second is AWS link if audio is uploaded
  answers: [{ textAnswer: String, audioAnswer: String, correctAnswer: Boolean }], 
